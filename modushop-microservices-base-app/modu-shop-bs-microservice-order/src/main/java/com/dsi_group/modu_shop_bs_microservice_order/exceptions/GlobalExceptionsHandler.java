...
import com.dsi_group.modu_shop_bs_microservice_order.domain.dtos.response.ErrorResponseDto;
...
public class GlobalExceptionsHandler {
  ...
  //  @ExceptionHandler
    public ResponseEntity<ErrorResponseDto> handle(RuntimeException exception) {
        ...
        switch (exception) {
            case RemoteServiceUnreachableException e -> {
            ...
            case StockNotEnoughException e -> {
            ...
            case RemoteServiceObjectNotFoundException e ->{
                errorResponseDto.setCode(notFound);
                errorResponseDto.setStatus(notFoundStatus.getReasonPhrase());
                errorResponseDto.setMessage(e.getMessage());
                return ResponseEntity.status(notFoundStatus).body(errorResponseDto);
